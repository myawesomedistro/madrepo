#!/bin/bash
set -e
aria2c http://ftp.us.debian.org/debian/pool/main/libc/libcdio/$(wget -qO- http://ftp.us.debian.org/debian/pool/main/libc/libcdio/|grep libcdio18|grep amd64.deb|head -n1|cut -d '"' -f2)
