...
wget -O- https://download.opensuse.org/repositories/home:SmartFinn:hardcode-tray/Debian_10/Release.gpg|sudo tee /etc/apt/trusted.gpg.d/hardcode-tray.gpg>/dev/null
apt-fast update
