...
POWERKIT_TAG=$(wget -O- --user '$GITHUB'_API_AUTH https://api.github.com/repos/rodlie/powerkit/releases|grep tag|head -n1|cut -d '"' -f4|sed 's/https:\/\/github.com\/rodlie\/powerkit\/releases\/tag\///g')
