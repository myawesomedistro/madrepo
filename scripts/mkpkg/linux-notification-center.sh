...
wget -O linux-notification-center/usr/bin/deadd-notification-center $(wget -O- https://api.github.com/repos/phuhl/linux_notification_center/releases|grep browser_download_url|head -n1|cut -d '"' -f4)
