...
#aria2c http://mirrors.kernel.org/ubuntu/pool/main/x/xcb-util/$(curl -s http://mirrors.kernel.org/ubuntu/pool/main/x/xcb-util/|grep amd64.deb|grep libxcb-util1|head -n1|cut -d '"' -f2)
