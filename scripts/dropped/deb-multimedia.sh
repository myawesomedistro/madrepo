...
aria2c http://www.deb-multimedia.org/pool/main/d/deb-multimedia-keyring/$(curl -s http://www.deb-multimedia.org/pool/main/d/deb-multimedia-keyring/|grep all.deb|head -n1|cut -d '"' -f2)
